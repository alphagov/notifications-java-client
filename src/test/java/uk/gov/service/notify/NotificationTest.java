...
public class NotificationTest {
    ...
    public void testEmailNotification_canCreateObjectFromJson() {
        ...
        assertEquals(ZonedDateTime.parse("2016-03-01T08:30:00.000Z", DateUtils.DATE_TIME_FORMATTER), notification.getCreatedAt());
        assertEquals(Optional.of(ZonedDateTime.parse("2016-03-01T08:30:03.000Z", DateUtils.DATE_TIME_FORMATTER)), notification.getSentAt());
        assertEquals(Optional.of(ZonedDateTime.parse("2016-03-01T08:30:43.000Z", DateUtils.DATE_TIME_FORMATTER)), notification.getCompletedAt());
        assertEquals(Optional.of(ZonedDateTime.parse("2016-03-03T16:00:00.000Z", DateUtils.DATE_TIME_FORMATTER)), notification.getEstimatedDelivery());
